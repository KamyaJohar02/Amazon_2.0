...
function Header() {
  return (
    <header>
      ...
      <div className="link" >
        <p>Hello, Kamya Johar</p>
        <p className="font-extrabold md:font-sm">Accounts & Lists</p>
      </div>
      <div className="link">
        <p>Returns </p>
        <p className="font-extraboldmd:font-sm"> & Orders</p>
      </div>
      <div className="link flex items-center relative">
      <span className="absolute bottom-6 h-4 w-4 bg-yellow-400 left-6 md:right-10 text-center rounded-full text-black ">0</span>
 ...
 <p className="hidden font-extrabold md:inline md:font-sm">Cart</p>
      ...
      <div className="flex flex-grow space-x-3 p-2 pl-6 bg-amazon_blue-light text-md text-white">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="h-6 mr-1">
